...
Route::prefix('friends')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('to-share-to', [ShareToFriendController::class, 'index']);
    Route::post('to-share-to', [ShareToFriendController::class, 'send']);
    Route::post('{user}/send', [RequestFriendController::class, 'send']);
    Route::post('{user}/cancel', [RequestFriendController::class, 'cancel']);
