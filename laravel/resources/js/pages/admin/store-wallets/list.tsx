...
export default function ListStoreWallets({
    wallets,
    kpis,
    filters,
}: ListStoreWalletsProps) {
    ...
    const [previewWallet, setPreviewWallet] =
        React.useState<StoreWallet | null>(null);
    ...
    const handleOpenPreview = async (wallet: StoreWallet) => {
        ...
        try {
            const response = await fetch(
                ShowStoreWalletController.show.url(wallet.id),
                {
                ...
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Audit vendor store ledger accounts, freeze balances,
                            check identity documents, and approve payouts.
                        </p>
                    </div>
                    <Button
                        variant="outline"
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="flex items-center gap-4 rounded-2xl border bg-card p-5 shadow-xs">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="mt-0.5 text-xl font-black text-foreground">
                                {kpis.verified_identity_count} Stores
                            </span>
                        </div>
                    </div>
                                        ...
                                        >
                                            <TableCell className="py-4 pl-6">
                                                <div className="flex items-center gap-3">
                                                    <div className="flex size-9 shrink-0 items-center justify-center overflow-hidden rounded-xl border bg-primary/10 text-xs font-bold text-primary uppercase">
                                                        {wallet.store?.logo ? (
                                                            <img
                                                                src={
                                                                    wallet.store
                                            ...
                                            <TableCell className="py-4 pr-6 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    >
                                                        <Link
                                                            href={ShowStoreWalletController.show.url(
                                                                wallet.id,
                                                            )}
                                                        >
                                                            Details
                                            ...
                                            <div className="flex flex-col items-center justify-center gap-3">
                                                ...
                                                <div className="flex flex-col gap-0.5">
                                                    <p className="text-sm font-semibold text-foreground">
                                                        No store wallets found
                                                    </p>
                                                    <p className="text-xs">
                                                        Adjust filter settings
                                                        to query store wallets.
                                                    </p>
                                                </div>
                                            </div>
                                        </TableCell>
                ...
                <SheetContent className="flex h-full flex-col bg-card sm:max-w-md">
                    <SheetHeader className="border-b pb-4">
                        <SheetTitle className="text-lg font-black text-foreground">
                            Store Wallet Auditor
                        </SheetTitle>
                        <SheetDescription className="text-xs text-muted-foreground">
                            Review store verification status, update account
                            status, and freeze funds.
                        </SheetDescription>
                    </SheetHeader>
                        ...
                        >
                            <div className="flex flex-col gap-6 overflow-y-auto p-4">
                                <div className="flex items-center gap-4 rounded-2xl border bg-muted/20 p-4">
                                    <div className="flex size-12 shrink-0 items-center justify-center overflow-hidden rounded-xl border bg-primary/10 text-base font-extrabold text-primary uppercase">
                                        {previewWallet.store?.logo ? (
                                            <img
                                                src={previewWallet.store.logo}
                                                alt={
                                                    previewWallet.store
                                                        .store_name
                                                }
                                    ...
                                    <div className="flex flex-col gap-0.5">
                                        <span className="text-sm font-extrabold text-foreground">
                                            {previewWallet.store?.store_name ||
                                                'N/A'}
                                        </span>
                                        <span className="text-xs font-semibold text-muted-foreground">
                                            {previewWallet.store
                                ...
                                <div className="flex items-center space-x-3 rounded-xl border bg-muted/10 p-4">
                                    ...
                                    <div className="grid gap-1.5 leading-none">
                                        ...
                                        <p className="text-[10px] text-muted-foreground">
                                            Confirm store has supplied correct
                                            business permits or legal
                                            identification.
                                        </p>
                                    </div>
                                </div>
