...
export default function StoreWalletShow({
    store_wallet,
    transactions,
    withdrawals,
}: StoreWalletShowProps) {
    ...
    const handleWithdrawalSubmit = (e: React.FormEvent) => {
        ...
        withdrawalForm.put(
            ShowStoreWalletController.updateWithdrawal.url({
                store_wallet: store_wallet.id,
                storeWithdrawalRequest: selectedWithdrawal.id,
            }),
            {
                onSuccess: () => {
    ...
    return (
        <>
            <Head
                title={`Store Wallet details - ${store_wallet.store?.store_name || 'N/A'}`}
            />
                ...
                <div className="flex flex-col justify-between gap-4 border-b pb-6 md:flex-row md:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Verify vendor balance operations, authorize payout
                            requests, and freeze ledger limits.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:col-span-8">
                        ...
                        <div className="flex flex-col gap-4 rounded-2xl border bg-card p-5 shadow-xs">
                            <div className="flex items-center gap-2 border-b pb-3.5">
                                <IconBuildingStore className="size-5 shrink-0 text-primary" />
                            ...
                            <div className="flex items-center gap-4 py-2">
                                <div className="flex size-14 shrink-0 items-center justify-center overflow-hidden rounded-xl border bg-primary/10 text-xl font-black text-primary uppercase">
                                    {store_wallet.store?.logo ? (
                                        <img
                                            src={store_wallet.store.logo}
                                            alt={store_wallet.store.store_name}
                                ...
                                <div className="flex flex-col gap-0.5">
                                    <span className="text-sm font-black text-foreground">
                                        {store_wallet.store?.store_name ||
                                            'N/A'}
                                    </span>
                                    <span className="text-xs font-semibold text-muted-foreground">
                                        {store_wallet.store?.phone_number ||
                                            'N/A'}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 py-1">
                                <div className="flex flex-col">
                                    ...
                                    <span className="mt-0.5 text-lg font-black text-foreground">
                                        {store_wallet.balance}{' '}
                                        {store_wallet.currency}
                                    </span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-bold tracking-wider text-muted-foreground uppercase">
