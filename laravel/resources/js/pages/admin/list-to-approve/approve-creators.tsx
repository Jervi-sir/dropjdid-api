...
export default function ListToApprove({
    ...
    const [previewRequest, setPreviewRequest] =
        React.useState<CreatorRequest | null>(null);
    ...
    React.useEffect(() => {
        if (selectedRequestId && sheetOpen) {
            ...
            fetch(BecomeCreatorController.show.url(selectedRequestId), {
                headers: {
    ...
    const applyFilters = (
        ...
        router.get(
            BecomeCreatorController.index.url(),
            {
    ...
    const handleApprove = () => {
        ...
        router.post(
            BecomeCreatorController.approve.url(selectedRequestId),
            {},
            {
                preserveScroll: true,
                preserveState: true,
    ...
    const handleRejectSubmit = (e: React.FormEvent) => {
        ...
        router.post(
            BecomeCreatorController.reject.url(selectedRequestId),
            {
                note: rejectionNote,
            },
            {
    ...
    return (
        <>
            <Head title="Creator Applications Moderation" />
                ...
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Moderate users applying to become creators. Review
                    ...
                    <SheetHeader className="border-b border-muted/50 bg-muted/10 p-6">
                        <div className="flex items-center justify-between gap-3">
                            <SheetTitle className="text-lg font-extrabold tracking-tight text-foreground">
                                Review Creator Request #{selectedRequestId}
                            </SheetTitle>
                            {previewRequest &&
                        ...
                        <SheetDescription className="text-xs text-muted-foreground">
                            ...
                            approve as a creator or submit rejection reasons.
                        </SheetDescription>
                    </SheetHeader>
